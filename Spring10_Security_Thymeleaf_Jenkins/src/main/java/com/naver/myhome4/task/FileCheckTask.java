...
public class FileCheckTask {
	...
	/*
	 스케줄러는 주어진 시간에 작업을 실행하도록 예약하는 시스템 또는 소프트웨어입니다.
	 이는 주기적인 작업이나 일회성 작업을 자동으로 실행하게 해줍니다.
	 주로 운영 체제나 응용 프로그램에서 사용되며, 시스템 관리, 데이터베이스 유지 보수, 백업 등의 작업을 자동화하는 데 유용합니다.
	 */
	//스케줄러를 이용해서 주기적으로 매일, 매주, 매월 프로그램 실행을 위한 작업을 실시합니다.
	//@Scheduled(fixedDelay=1000)   //밀리세컨드 단위를 사용하며 1초 마다 "test"라는 로그가 나타납니다.
	public void test() throws Exception{
		Logger.info("test");
	}
	
	//"cron"은 유닉스 및 리눅스 시스템에서 주기적인 작업을 예약하기 위해 사용되는 시스템 스케줄러입니다.
